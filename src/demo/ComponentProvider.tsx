...
import * as ChatUI from "@chatui/core";
import { ComponentsMap, LazyComponentOnLoadParams } from "@chatui/core";
...
function LazySlot() {
  ...
  return (
    <LazyComponent
      ...
      meta={{}}
      ctx={ctx}
      onLoad={(r: LazyComponentOnLoadParams) =>
        console.log("slot - onLoad:", r)
      }
    />
  );
}
